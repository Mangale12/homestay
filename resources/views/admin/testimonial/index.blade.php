                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-2">
                            @can('create-post')
                                <a href="{{route('testimonial.create')}}" class="btn btn-success btn-sm">Add Testimonial</a>
                            @endcan
                            ...
                            <tbody>
                                @if(count($testimonials)>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(empty($testimonial->profile))
                                                <img src="{{asset('public/category/no-image.png')}}" alt="no-image" width="80px" height="80px" class="img-fluid">
                                            @else
                                                <img src="{{asset('public/uploads/testimonial/'.$testimonial->profile)}}" alt="{{$testimonial->name}}" width="80px" height="80px" class="img-fluid">
                                            @endif
                                        </td>
                                        ...
                                        <td><a href="{{ route('testimonial.edit', $testimonial->id) }}"><i class="fas fa-edit"></i></a>
                                        <a href="{{ route('testimonials.delete', $testimonial->id) }}"><i class="fas fa-trash-alt"></i></a></td>
