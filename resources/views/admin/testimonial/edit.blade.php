                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{route('testimonial.index')}}" class="btn btn-success btn-sm float-right">View
                                        Testimonial</a>
                                </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    value="{{old($testimonial->name,'name')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="headline"> Position</label> <span class="text-danger"> *
                                                </span>
                                                <input type="text" class="form-control" name="position"
                                                    value="{{old($testimonial->position,'position')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="kicker">Message</label>
                                                <textarea name="message" id="description" class="form-control">{!! $testimonial->message !!}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="head_img">Profile</label>
                                                <div id="featured_img" class="row">
                                                    <div class="col-md-6 remove">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy"  src="{{ asset('public/uploads/testimonial/'.$testimonial->profile) }}" class="img-responsive" style="max-height:150px;">
