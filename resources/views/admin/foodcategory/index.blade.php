        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                        <a href="{{route('foodcategories.create')}}" class="btn btn-success btn-sm float-right">Add Category</a>
                </div>
                        ...
                        <tbody>
                            @if(count($categories)>0)
                                ...
                                <tr>
                                    ...
                                    <td>{{$category->slug}}</td>
                                    <form action="{{route('foodcategories.delete',$category->slug)}}" method="post" id="submit_form">
                                        @csrf
                                        @method('delete')
                                        <td class="project-actions">
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{route('foodcategories.edit',$category->slug)}}">
                                            ...
                                            {{-- <a href="category/delete/{{$category->slug}}" class="btn btn-danger"><i class="fa fa-trash"></i></a> --}}
