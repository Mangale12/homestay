...
<form action="{{route('about-us.update',$about_us->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                                ...
                                                <div id="featured_img" class="row">
                                                    ...
                                                    <div class="col-md-6 remove">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy"  src="{{ asset('public/uploads/'.$about_us->image) }}" class="img-responsive" style="max-height:150px;">

                                                            <button type="button" class="btn btn-danger close-btn remove-files" data-id="{{ $about_us->id }}"><i class="fa fa-times"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="head_img">Side Image</label>
                                                <div id="featured_img" class="row">
                                                </div>
                                            </div>
                                        </div>
