        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                        <a href="{{route('country.create')}}" class="btn btn-success btn-sm float-right">Add Category</a>
                </div>
                        ...
                        <tbody>
                            @if(count($countries)>0)
                                ...
                                <tr>
                                    ...
                                    {{-- <td>{{$category->slug}}</td> --}}
                                    <form action="{{route('categories.destroy',$country->id)}}" method="post" id="submit_form">
                                        @csrf
                                        @method('delete')
