                            ...
                            <div id="single_news" class="row">
                                <div class="col-lg-6 col-md-6 remove">
                                    <div class="img-upload-preview">
                                        <input type="hidden" value="{{ json_decode($ads->single_news)->img }}" id="add_id">
                                        <img loading="lazy"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div id="after_single_headline" class="row">
                                <div class="col-lg-6 col-md-6 remove">
                                    <input type="hidden" value="{{ json_decode($ads->after_single_headline)->img }}" id="add_id">
                                    <div class="img-upload-preview">
                                        <img loading="lazy"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div id="single_sidebar1" class="row">
                                    <div class="col-lg-6 col-md-6 remove">
                                        <div class="img-upload-preview">
                                            <input type="hidden" value="{{ json_decode($ads->single_sidebar1)->img }}" id="add_id">
                                            <img loading="lazy"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div id="single_sidebar2" class="row">
                                    <div class="col-lg-6 col-md-6 remove">
                                        <div class="img-upload-preview">
                                            <input type="hidden" value="{{ json_decode($ads->single_sidebar2)->img }}" id="add_id">
                                            <img loading="lazy"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div id="single_sidebar3" class="row">
                                    <div class="col-lg-6 col-md-6 remove">
                                        <div class="img-upload-preview">
                                            <input type="hidden" value="{{ json_decode($ads->single_sidebar3)->img }}" id="add_id">
                                            <img loading="lazy"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div id="single_after_header" class="row">
                                <div class="col-lg-6 col-md-6 remove">
                                    <input type="hidden" value="{{ json_decode($ads->single_after_header)->img }}" id="add_id">
                                    <div class="img-upload-preview">
                                        <img loading="lazy"
...
<script type="text/javascript">
    $('.remove-files').on('click', function () {
        let ad_name = $('#add_id').val();
        $.ajax({
                type:'GET',
                dataType:'json',
                url:'{{ route('add.delete_image') }}',
